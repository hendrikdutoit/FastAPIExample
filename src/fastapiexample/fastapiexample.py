...
def do_examples(p_cls=True):
    '''A collection of implementation examples for FastAPIExample.

    A collection of implementation examples for FastAPIExample. The examples
...
def do_example1(p_cls=True):
    '''A working example of the implementation of FastAPIExample.
...
def do_example2(p_cls=True):
    '''Another working example of the implementation of FastAPIExample.
