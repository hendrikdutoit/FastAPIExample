...
_INDEX_RST_BADGE_CODECOV = '''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/fastapiexample
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/fastapiexample

'''
_INDEX_RST_BADGE_GITHUB_CI = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapiexample/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/fastapiexample/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = '''.. image:: https://img.shields.io/github/search/hendrikdutoit/fastapiexample/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = '''.. image:: https://img.shields.io/github/license/hendrikdutoit/fastapiexample
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = '''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/fastapiexample
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapiexample/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/fastapiexample/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = '''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/fastapiexample
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = '''.. image:: https://img.shields.io/testpypi/v/fastapiexample
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = '''.. image:: https://img.shields.io/pypi/dm/fastapiexample
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = '''.. image:: https://img.shields.io/pypi/status/fastapiexample
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = '''.. image:: https://img.shields.io/pypi/wheel/fastapiexample
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = '''.. image:: https://img.shields.io/pypi/pyversions/fastapiexample
...
.. image:: https://img.shields.io/pypi/status/fastapiexample
    :alt: PyPI - Status

.. image:: https://img.shields.io/pypi/wheel/fastapiexample
    :alt: PyPI - Wheel

.. image:: https://img.shields.io/pypi/pyversions/fastapiexample
    :alt: PyPI - Python Version

.. image:: https://img.shields.io/github/v/release/hendrikdutoit/fastapiexample
    :alt: GitHub release (latest by date)

.. image:: https://img.shields.io/github/license/hendrikdutoit/fastapiexample
    :alt: License

.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/fastapiexample
    :alt: GitHub issues

.. image:: https://img.shields.io/pypi/dm/fastapiexample
    :alt: PyPI - Downloads

.. image:: https://img.shields.io/github/search/hendrikdutoit/fastapiexample/GitHub hit
    :alt: GitHub Searches

.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/fastapiexample
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/fastapiexample

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapiexample/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/fastapiexample/actions/workflows/pre-commit.yaml

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapiexample/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/fastapiexample/actions/workflows/ci.yaml

.. image:: https://img.shields.io/testpypi/v/fastapiexample
    :alt: PyPi
